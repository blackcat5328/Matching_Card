    ...
    function Hand() {
        ...
        useFrame((state) => {
          if (handRef.current) {
            ...
            // Control visibility based on mouse position
            setIsVisible(mouse.x >= 0); // Show hand only when mouse is on the right
        ...
        return React.createElement(
          'group',
          { ref: handRef, onClick: handleClick, visible: isVisible }, // Set visibility
